...
{
    static constexpr auto Linear = [](double t) {
        return CubicInterpolation{}({0.0F, 0.0}, {1.0, 1.0}, t).y;
    };
    static constexpr auto EaseOut = [](double t) {
        return CubicInterpolation{}({0.0, 0.0}, {0.58, 1.0}, t).y;
    };
    static constexpr auto EaseInOut = [](double t) {
        return CubicInterpolation{}({0.42, 0.0}, {0.58, 1.0}, t).y;
    };
    static constexpr auto EaseInOutBack = [](double t) {
